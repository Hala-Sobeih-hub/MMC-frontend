...
export default function Footer() {
  return (
    // <div className="bg-secondary text-white py-4 flex flex-direction-row justify-center align-items-center gap-10">
    <div
      id="contact-jump"
      className="bg-secondary py-5 sm:py-8 px-4 min-h-[300px]"
    >
      {/* Responsive Layout */}
      <div className="flex flex-col sm:flex-row items-center font-bold sm:items-start justify-center gap-8 sm:gap-20 px-4">
        {/* Contact Information */}
        <div className="flex flex-col items-center sm:items-start text-white space-y-4">
          {/* Logo */}
          ...
          {/* Address */}
          <div className="text-center text-neutral  sm:text-left">
          ...
          {/* Phone */}
          <div className="flex items-center text-neutral justify-center sm:justify-start space-x-2">
            <FaPhone />
        ...
        {/* Inquiry Button */}
        <div className="flex flex-col items-center sm:items-start justify-center lg:mt-25">
